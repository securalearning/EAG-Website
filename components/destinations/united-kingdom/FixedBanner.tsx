    ...
    <div className="fixed bottom-0 left-0 z-50 w-full bg-gradient-to-r from-red-600 to-red-700 py-4 shadow-lg">
      <Container>
        <div className="relative flex flex-col items-center justify-between gap-4 text-white sm:flex-row">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold">
                Get Expert Guidance for UK Education
              </p>
              <p className="text-white/90">
                Book your free counselling session worth ₹2,000 today!
              </p>
            </div>
          </div>
          <Button 
          ...
          >
            <Link href="/get-started?serviceName=Free Counselling&fromPage=UK_FixedCounsellingBanner">Book Free Consultation</Link>
            </Button>
          <button
