...
const steps = [
  {
    ...
    description: 'Research and shortlist Irish universities based on your preferences.',
  ...
  },
  {
    icon: FileSearch,
    title: 'Student Visa',
    description: 'Apply for your Irish student visa.',
    ...
    <section className="py-24 bg-green-50">
      <Container>
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-green-700">Application Process</h2>
          <p className="mx-auto max-w-2xl text-lg text-green-600">
            A step-by-step guide to applying to Irish universities
          </p>
        </div>
            ...
            return (
              <Card key={step.title}>
                <CardContent className="p-6">
                  ...
                  <div className="mb-4">
                    <p className="mb-2 text-green-600">{step.description}</p>
                    <p className="text-sm font-medium text-orange-600">{step.timeline}</p>
                  </div>
                  <div className="space-y-2">
                    <p className="font-medium text-green-700">Key Points:</p>
                    <ul className="list-inside list-disc space-y-1 text-sm text-green-600">
                      {step.tips.map((tip) => (
                        <li key={tip}>{tip}</li>
                      ))}
                    </ul>
